...
TEST_BUDGET_TIMESTEPS_LIST = [90]
BUDGET = BUDGET_TIMESTEPS * BUDGET_TIMESTEP_METERS
MAX_BUDGET = BUDGET
RETURN_SAFETY_MARGIN = 0.0
SIMULATE_RETURN_TO_BASE = True
TEST_BREAKDOWN_STUDY_ENABLED = False
TEST_BREAKDOWN_AGENT_COUNT = 1
TEST_BREAKDOWN_MIN_STEP = 30
TEST_BREAKDOWN_MAX_STEP = MAX_EPISODE_STEP
TEST_BREAKDOWN_RANDOM_SEED = 0
